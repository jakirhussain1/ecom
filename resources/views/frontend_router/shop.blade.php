			                  ...
			                  <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
			                     <div class="panel panel-default">
			                         <div class="panel-heading" role="tab" id="headingOne">
			                             <h4 class="panel-title">
			                                 <a class="collapsed" href="shop.html" aria-expanded="true" aria-controls="collapseOne">Men
			                                 </a>
			                             </h4>
			                         </div>
			                     </div>
			                     ...
			                     <div class="panel panel-default">
			                         <div class="panel-heading" role="tab" id="headingTwo">
			                             <h4 class="panel-title">
			                                 <a class="collapsed"  href="shop.html" aria-expanded="false" aria-controls="collapseTwo">Women</a>
			                             </h4>
			                         </div>
			                     </div>
			                     ...
			                     <div class="panel panel-default">
			                         <div class="panel-heading" role="tab" id="headingThree">
			                             <h4 class="panel-title">
			                                 <a class="collapsed"  href="shop.html" aria-expanded="false" aria-controls="collapseThree">Child</a>
			                             </h4>
			                         </div>
			                     ...
			                     <div class="panel panel-default">
			                         <div class="panel-heading" role="tab" id="headingFour">
			                             <h4 class="panel-title">
			                                 <a class="collapsed" href="shop.html" aria-expanded="false" aria-controls="collapseThree">Electronics
			                                 </a>
			                             </h4>
			                         </div>
			                     </div>
